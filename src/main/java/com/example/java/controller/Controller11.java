...
import com.example.java.dto.c10.Car;
import com.example.java.dto.c11.CarList;
import com.example.java.dto.c11.Person;
import com.example.java.dto.c11.Player;
import com.example.java.dto.c11.Student;
...
public class Controller11 {
    ...
    public String sub1(Model model) {
        //String, 기본타입, 배열, List, map, java, javabeans
        var data = List.of(
                Map.of(
                        "name", "흥민",
                        "team", "토트넘"),
    ...
    public String sub5(Model model) {
        ...
        var students = List.of(
                ...
                new Student(10, "otani", 22, 66.1234, "naver")
        );
    ...
    public String sub6(Model model) {
        model.addAttribute("carList", List.of(
                new CarList("model x", 5000, false),
                new CarList("model s", 4000, true),
                new CarList("model s", 4000, true)
        ));
        return null;
    }
