...
import com.example.java.dto.c21.*;
...
public class Controller21 {
    ...
    @GetMapping("sub2")
    public String g2(@ModelAttribute(name = "some1") Object o) {
        return "/main21/sub1";
    }

    //  @ModelAttribute 을 붙인 메소드 아큐먼트(객체)는
    // request parameter 가 객체의 property 에 binding 된다.
    @GetMapping("sub3")
    public void g3() {
    ...
    @PostMapping("sub3")
    public void p3(@ModelAttribute(name = "some") MyBean b) {
    ...
    @PostMapping("sub5")
    public void p5(@ModelAttribute(name = "data") MyBean5 b) {
        System.out.println("b = " + b);
    }
    ...
    @PostMapping("sub9")
    public void p9(MyBean8 p, Model model) {
        System.out.println("p = " + p);
        Object m = model.getAttribute("myBean8");
    }
