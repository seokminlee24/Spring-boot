...
public class Controller16 {
    ...
    @RequestMapping("sub4")
    public void sub4(Model model, HttpSession session) {

    }

    @RequestMapping("sub5")
    public void sub5(@RequestParam(value = "id", required = false) String id,
    ...
    @RequestMapping("sub7")
    public void sub5(Model model, HttpSession session) {
