...
public class Controller08 {
    ...
    public String sub2(Model model) {
        ...
        //attribute 는 아무것이나 넣을 수 있음(Object 타입이라서)
    ...
    public String sub4(Model model) {
        ...
        model.addAttribute("points", new String[]{"3.14","9.4321","8.0101"});
        return null;
    }
    ...
    public String sub5(Model model) {
        ...
        model.addAttribute("classes",new String[]{"자바","리엑트"});
    ...
    public String sub6(Model model) {
        //attribute 에 List 넣기
        model.addAttribute("names",List.of("손흥민","몽규","홍명보"));
        return null;
    }
    ...
    public String sub8(Model model) {
        model.addAttribute("students",List.of("손흥민","몽규","홍명보"));
